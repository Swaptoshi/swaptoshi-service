...
// Governance
const MODULE_NAME_GOVERNANCE = 'governance';
const EVENT_NAME_TREASURY_BLOCK_REWARD_TAX = 'treasuryBlockRewardTax';
const EVENT_NAME_TREASURY_MINT = 'treasuryMint';
const EVENT_NAME_CONFIG_UPDATED = 'configUpdated';
const EVENT_NAME_DELEGATED_VOTE_REVOKED = 'delegatedVoteRevoked';
const EVENT_NAME_PROPOSAL_ACTIVE = 'proposalActive';
const EVENT_NAME_PROPOSAL_CREATED = 'proposalCreated';
const EVENT_NAME_PROPOSAL_EXECUTED = 'proposalExecuted';
const EVENT_NAME_PROPOSAL_OUTCOME = 'proposalOutcome';
const EVENT_NAME_PROPOSAL_QUORUM_CHECKED = 'proposalQuorumChecked';
const EVENT_NAME_PROPOSAL_SET_ATTRIBUTES = 'proposalSetAttributes';
const EVENT_NAME_PROPOSAL_VOTED = 'proposalVoted';
const EVENT_NAME_VOTE_BOOSTED = 'voteBoosted';
const EVENT_NAME_VOTE_CHANGED = 'voteChanged';
const EVENT_NAME_VOTE_DELEGATED = 'voteDelegated';
